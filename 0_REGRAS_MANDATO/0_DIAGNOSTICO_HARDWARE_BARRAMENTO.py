...
Arquivo sugerido:
    <PROJECT_ROOT>\\0_REGRAS_MANDATO\\0_DIAGNOSTICO_HARDWARE_BARRAMENTO.py

Única saída:
    <PROJECT_ROOT>\\0_REGRAS_MANDATO\\BASE_JSON\\ARCHANGEL_MACHINE_PROFILE.json
...
OUTPUT_JSON_NAME = "ARCHANGEL_MACHINE_PROFILE.json"
