...
BASE_ARQUIVOS_PATH = BASE_JSON_DIR / "BASE_ARQUIVOS.json"
...
RUN_REPORT_LATEST_PATH = BASE_JSON_DIR / "4_LABELS_RUN_REPORT_LATEST.json"
...
def main() -> None:
    ...
    if not feature_files:
        raise RuntimeError(
            "Nenhum arquivo de features encontrado. Verifique 3_JSON_FEATURES.json e FEATURES_PARQUET_DIR."
        )
